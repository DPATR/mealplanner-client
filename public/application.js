...
var config = {
  apiOrigins: {
    production: 'https://ancient-gorge-70615.herokuapp.com',
...
var addNewMeal = function addNewMeal(data) {
...
var addMealIngredient = function addMealIngredient(data) {
...
var deleteMeal = function deleteMeal(mealId) {
...
var showMealById = function showMealById(id) {
...
var mealsApi = __webpack_require__(6);
var showEventsTemplate = __webpack_require__(21);
var getFormFields = __webpack_require__(3);

var store = __webpack_require__(2);

var addIngredientsFromMeal = function addIngredientsFromMeal() {
  var newGroceryItem = false;

  // console.log('newGroceryItem is ', newGroceryItem)

  if (store.entree) {
    var newElement = store.entree;
    // console.log('store.entree is ', newElement)
    newGroceryItem = true;
    buildNewGroceryItem(newElement);
  }
  if (store.side1) {
    var _newElement = store.side1;
    // console.log('store.side1 is ', newElement)
    newGroceryItem = true;
    buildNewGroceryItem(_newElement);
  }
  if (store.side2) {
    var _newElement2 = store.side2;
    // console.log('store.side2 is ', newElement)
    newGroceryItem = true;
    buildNewGroceryItem(_newElement2);
  }
};
//
var buildNewGroceryItem = function buildNewGroceryItem(element) {
  ...
  };mealsApi.addMealIngredient(newIngredientData).then(addMealIngredientSuccess).catch(addMealIngredientFailure);
};

var addMealIngredientSuccess = function addMealIngredientSuccess(data) {
...
var addMealIngredientFailure = function addMealIngredientFailure() {
...
var addMealSuccess = function addMealSuccess(data) {
  ...
  mealsApi.getAllMeals().then(getMealsSuccess).catch(getMealsFailure);
};

var addMealFailure = function addMealFailure() {
...
var getMealsSuccess = function getMealsSuccess(data) {
  ...
  $('#list-content').empty();
  var showEventsHtml = showEventsTemplate({ meals: data.meals });
  $('.content').html(showEventsHtml);
};

var getMealsFailure = function getMealsFailure() {
  $('#message').text('Unexpected error retrieving data for this meal. Please try again.');
};

var deleteMealSuccess = function deleteMealSuccess() {
  // console.log('in deleteMealSuccess')

  mealsApi.getAllMeals().then(getMealsSuccess).catch(getMealsFailure);
};

var deleteMealFailure = function deleteMealFailure() {
...
var onMealUpdate = function onMealUpdate(event) {
  ...
  .then(onUpdateSuccess).catch(onUpdateFailure);
};
...
module.exports = {
  ...
  getMealsSuccess: getMealsSuccess,
  getMealsFailure: getMealsFailure,
...
var addNewIngredient = function addNewIngredient(data) {
  return $.ajax({
    url: config.apiOrigin + '/ingredients',
    method: 'POST',
    headers: {
...
var showIngredientById = function showIngredientById(id) {
...
var updateIngredient = function updateIngredient(data) {
  return $.ajax({
...
module.exports = {
  ...
  showIngredientById: showIngredientById,
...
var mealEvents = __webpack_require__(38);
var ingredientEvents = __webpack_require__(39);
...
var onSearchGoogle = function onSearchGoogle(event) {
  event.preventDefault();
...
var onOpenHtml = function onOpenHtml(event) {
  event.preventDefault();
...
var onSignUp = function onSignUp(event) {
  ...
  }).then(authUi.signInSuccess).catch(authUi.signUpFailure);
};
...
var onSignOut = function onSignOut(event) {
  ...
  event.preventDefault();
  var data = getFormFields(this);
  authApi.signOut(data).then(authUi.signOutSuccess).catch(authUi.signOutFailure);
};

var OnCancelModal = function OnCancelModal(event) {
...
var store = __webpack_require__(2);
var mealsApi = __webpack_require__(6);
var mealsUi = __webpack_require__(8);
...
var signInSuccess = function signInSuccess(data) {
  ...
  mealsApi.getAllMeals().then(mealsUi.getMealsSuccess).catch(mealsUi.getMealsFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"row\">\n"
    ...
    + "      <div class=\"col-md-4\">\n      <button class=\"editEvent meal-button\" id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Edit</button>\n      <button class=\"removeMealEvent meal-button\" id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Remove</button>\n      <button class=\"externalLink\" id=\""
  ...
  return "        <div class=\"col-xs-12 col-md-4\">\n        <h3 class=handlebarsDay>"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.weekday : stack1), depth0))
    + "</h3>\n        <h4 class=handlebarsType>"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.mealtype : stack1), depth0))
    + "</h4>\n        </div>\n        <div class=\"col-md-4\">\n        <p class=list-group-item-text1>"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.entree : stack1), depth0))
    + "<br>\n        <p class=list-group-item-text2>"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.side1 : stack1), depth0))
    + "<br>\n        <p class=list-group-item-text3>"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.side2 : stack1), depth0))
    + "<br>\n        </div>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "        <p id=\"mealmsg\">You have no meals to display!</p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.meals : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
var onGetCurrentPosition = function onGetCurrentPosition(event) {
  // console.log('in onGetCurrentPosition')
  navigator.geolocation.getCurrentPosition(c);
  return false;
};

var onAddMeal = function onAddMeal(event) {
  // console.log('in meals events, onAddMeal')

  event.preventDefault();
  var data = getFormFields(this);
  initVariables();
  mealsApi.addNewMeal(data).then(mealsUi.addMealSuccess).catch(mealsUi.addMealFailure);
};

var onGetMeals = function onGetMeals() {
...
var OnCancelModal = function OnCancelModal() {
  event.preventDefault();
  setTimeout(function () {
    $('#message').text('');
  }, 4000);
...
var onDeleteMeal = function onDeleteMeal(event) {
  // console.log('In meals-events.js')

  var mealId = event.target.getAttribute('id');
  // event.target is <button class="delete" type="button" data-id="9">

  // console.log('In meal-events, meal id is ', mealId)

  mealsApi.deleteMeal(mealId).then(mealsUi.deleteMealSuccess).then(function () {
    return mealsApi.getAllMeals();
  }).then(mealsUi.getMealsSuccess).catch(mealsUi.deleteMealFailure);
};

var onEditEvent = function onEditEvent(event) {

  mealsApi.showMealById(event.target.id).then(onShowIdForEditSuccess).catch(onShowByIdForEditFailure);
};

var onShowIdForEditSuccess = function onShowIdForEditSuccess(response) {
...
var onShowByIdForEditFailure = function onShowByIdForEditFailure() {
...
var onExternalLink = function onExternalLink(event) {
  event.preventDefault();
...
var getFormFields = __webpack_require__(3);
var ingredientsApi = __webpack_require__(11);
var ingredientsUi = __webpack_require__(40);
var store = __webpack_require__(2);
...
var onSetupGoogle = function onSetupGoogle(event) {
...
var onAddIngredient = function onAddIngredient(event) {
  ...
  var data = getFormFields(this);
  initVariables();
  ingredientsApi.addNewIngredient(data).then(ingredientsUi.addIngredientSuccess).catch(ingredientsUi.addIngredientFailure);
};

var onGetIngredients = function onGetIngredients() {
  // this version uses Geolocation
  // console.log('in ingredients events, onGetIngredients')

  var currLocation = store.coords;
  ...
  if (!currLocation) {
    ...
    initVariables();
    ingredientsApi.getAllIngredients().then(ingredientsUi.getIngredientsSuccess).catch(ingredientsUi.getIngredientsFailure);
  }
};
...
var onDeleteIngredient = function onDeleteIngredient(event) {
  ...
  ingredientsApi.deleteIngredient(ingredientId).then(ingredientsUi.deleteIngredientSuccess).catch(ingredientsUi.deleteIngredientFailure);
};

var onEditIngEvent = function onEditIngEvent(event) {
  // console.log('in ingredients-events.js event.target is ', event.target)
  // console.log('event.target.id is ', event.target.id)

  ingredientsApi.showIngredientById(event.target.id).then(onShowIdForEditSuccess).catch(onShowByIdForEditFailure);
};
...
var onIngExternalLink = function onIngExternalLink(event) {
  event.preventDefault();
  window.open(event.target.id, 'http://www.google.com');
};

var onIngExternalLink2 = function onIngExternalLink2(event) {
  event.preventDefault();
...
var ingredientsApi = __webpack_require__(11);
var showEventsTemplate = __webpack_require__(41);
var getFormFields = __webpack_require__(3);
var store = __webpack_require__(2);

var addIngredientSuccess = function addIngredientSuccess(data) {
  ...
  ingredientsApi.getAllIngredients().then(getIngredientsSuccess).catch(getIngredientsFailure);
};

var addIngredientFailure = function addIngredientFailure() {
...
var getIngredientsSuccess = function getIngredientsSuccess(data) {
  ...
  var location = store.coords;

  // console.log('location is ', location)

  data.ingredients.map(function (ingredients) {
  ...
  $('#list-content').empty();
  var showEventsHtml = showEventsTemplate({ ingredients: data.ingredients });
  $('.content').html(showEventsHtml);
};

var getIngredientsFailure = function getIngredientsFailure() {
  $('#message').text('Unexpected error retrieving data for this grocery item. Please try again.');
};

var deleteIngredientSuccess = function deleteIngredientSuccess() {
  ingredientsApi.getAllIngredients().then(getIngredientsSuccess).catch(getIngredientsFailure);
};

var deleteIngredientFailure = function deleteIngredientFailure() {
  $('#message').show();
...
var onIngredientUpdate = function onIngredientUpdate(event) {
...
module.exports = {
  ...
  addIngredientFailure: addIngredientFailure,
  getIngredientsSuccess: getIngredientsSuccess,
  getIngredientsFailure: getIngredientsFailure,
  deleteIngredientSuccess: deleteIngredientSuccess,
  deleteIngredientFailure: deleteIngredientFailure,
  onUpdateSuccess: onUpdateSuccess,
  onUpdateFailure: onUpdateFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div class=\"col-xs-12 col-md-6 col-lg-4\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.id : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      <div>\n      <button class=\"editIngEvent ingredient-button\" id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Edit</button>\n      <button class=\"removeIngredientEvent meal-button\" id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Remove</button>\n      <button class=\"ingExternalLink2\" id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url2 : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.label2 : stack1), depth0))
    + "</button>\n      <button class=\"ingExternalLink\" id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.label : stack1), depth0))
    + "</button>\n      </div>\n    </div>\n";
  ...
  return "        <h3 id=\"ingredientitem\" class=\"handlebarsIngredient\">"
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.ingredient : stack1), depth0))
    + "</h3>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "        <p id=\"ingredmsg\">You have no groceries to display!</p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
// module
exports.push([module.i, "a.hover {\n  text-decoration: none;\n}\n\na.hover:hover {\n  text-decoration: underline;\n}\n\n#log-out, #change-pw {\n  color: #286090;\n  font-size: 30px;\n  font-style: italic;\n  font-weight: bold;\n}\n\n#signup {\n  color: #c50a0a;\n  font-size: 50px;\n  font-style: italic;\n  font-weight: bold;\n  padding-right: 30px;\n}\n\n#log-in {\n  color: #c50a0a;\n  font-size: 50px;\n  font-style: italic;\n  font-weight: bold;\n  padding-right: 50px;\n}\n\n#change-pw {\n  color: #286090;\n  padding-right: 20px;\n}\n\n.handlebarsDay {\n  color: #6f0404;\n  font-size: 40px;\n  padding-left: 30px;\n  text-align: justify;\n}\n\n.handlebarsType {\n  color: #5e5e5e;\n  font-size: 40px;\n  padding-left: 80px;\n  text-align: justify;\n}\n\n.list-group-item-text1, .list-group-item-text2, .list-group-item-text3 {\n  color: #5e5e5e;\n  font-size: 35px;\n  margin-top: 35px;\n  padding-left: 30px;\n  text-align: left;\n}\n\n.removeMealEvent {\n  margin-top: 35px;\n}\n\n#ingredientitem {\n  color: #5e5e5e;\n  font-size: 35px;\n  padding-bottom: 30px;\n  padding-top: 80px;\n}\n\n.stroked {\n  text-decoration: line-through;\n}\n\n.get-lists-btns {\n  text-align: center;\n  margin: auto;\n  margin-top: 60px;\n  margin-bottom: 45px;\n}\n\n#getIngredients {\n  background-color: #cecece;\n  color: #286090;\n  display: inline-block;\n  font-size: 25px;\n  text-align: center;\n}\n\n#getMeals {\n  background-color: #cecece;\n  color: #286090;\n  display:inline-block;\n  font-size: 25px;\n  text-align: center;\n}\n\n#create-meal {\n  background-color: #cecece;\n  color: #286090;\n  font-size: 25px;\n  margin-left: 4px;\n  text-align: center;\n}\n\n#create-ingredient {\n  background-color: #cecece;\n  color: #286090;\n  font-size: 25px;\n  margin-left: 4px;\n  text-align: center;\n}\n\nbody {\n  background-attachment: fixed;\n  background-color: white;\n  background-image: url(https://i.imgur.com/sK3o13L.jpg);\n  background-position: center center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  clear: both;\n  text-align: center;\n}\n\n#google_map {\n  border:2px solid gray;\n  display: none;\n}\n\n.Holder {\n  margin-top: 35px;\n  margin-bottom: 65px;\n}\n\n.topHeading {\n  color: #204e76;\n  display: none;\n  font-family: cursive;\n  font-size: 110px;\n  font-style: normal;\n  font-variant: normal;\n  font-weight: 400;\n  padding-bottom: 22px;\n  padding-top: 75px;\n  text-align: center;\n  vertical-align:middle;\n  width: 100vw;\n}\n\n.topHeadingMain1 {\n  color: #024d02;\n  font-family: cursive;\n  font-size: 225px;\n  font-style: normal;\n  font-variant: normal;\n  font-weight: bold;\n  font-weight: 520;\n  line-height: 26.4px;\n  z-index: 100;\n  position: absolute;\n  left: 980px;\n  top: 260px;\n}\n\n.topHeadingMain2 {\n  color: #024d02;\n  font-family: cursive;\n  font-size: 225px;\n  font-style: normal;\n  font-variant: normal;\n  font-weight: 520;\n  line-height: 26.4px;\n  z-index: 100;\n  position: absolute;\n  left: 1140px;\n  top: 590px;\n}\n\n.topHeading2 {\n  color: #204e76;\n  font-family: 'Railway', 'Sans Serif';\n  font-size: 65px;\n}\n\n.topHeading3 {\n  color: #204e76;\n  font-family: 'Railway', 'Sans Serif';\n  font-size: 65px;\n}\n\n#content {\n  clear: both;\n  margin-top: 35px;\n}\n\n.editEvent {\n  background-color: #cecece;\n  color: #008000;\n  font-size: 22px;\n}\n\n.editIngEvent {\n  background-color: #cecece;\n  color: #008000;\n  font-size: 19px;\n}\n\n.externalLink {\n  background-color: #cecece;\n  color: #286090;\n  font-size: 22px;\n}\n\n.ingExternalLink, .ingExternalLink2 {\n  background-color: #cecece;\n  color: #286090;\n  font-size: 19px;\n}\n\n.removeMealEvent {\n  background-color: #cecece;\n  color: #6f0404;\n  font-size: 22px;\n}\n\n.removeIngredientEvent {\n  background-color: #cecece;\n  color: #6f0404;\n  font-size: 19px;\n}\n\n.message-box {\n  color: red;\n}\n", ""]);
